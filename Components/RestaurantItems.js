...
export const localRestaurants = [
  {
    ...
    rating: 4.5,
    description:
      'Restaurant Restaurant description. Availability. Check rates, availability, and book online with our secure reservation system. Best Price Guarantee.',
  },
  {
    name: 'Benihana',
    image_url:
...
const RestaurantImage = props => (
  <View>
    <Image source={{uri: props.image}} style={{width: '100%', height: 180,borderRadius:7}} />
